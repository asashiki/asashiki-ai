...
// 来源：viking://resources/project/asashiki-mcp/console-api.md
// =============================================================================
...
export interface HealthOverview {
  ...
  coreApi: { ok: boolean; note?: string };
  /** 各连接器状态：来自现有 connector_status 工具的内部数据 */
  connectors: Array<{
    id: string;             // okx | weather | minimax | viking | x-search 等
    name: string;
