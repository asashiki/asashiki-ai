...
// 本地开发：默认走 vite proxy → /api/* → https://mcp.asashiki.com
const BASE = import.meta.env.VITE_API_BASE ?? "";

const TOKEN_KEY = "asashiki.console.token";
const USER_KEY  = "asashiki.console.user";
...
export const Remote = {
  ...
  add: (s: { name: string; url: string; clientId?: string; clientSecret?: string; bearerToken?: string }) =>
