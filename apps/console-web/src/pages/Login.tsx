...
export default function Login({ onSuccess }: { onSuccess: () => void }) {
  const [username, setUser] = useState("asashiki");
  ...
  return (
    <div className="login-page">
      <aside className="login-left">
        ...
        <div className="colo">
          <div><span className="k">EDITION</span>2026.6</div>
          <div><span className="k">ENDPOINT</span>mcp.asashiki.com</div>
        ...
        <form className="login-form" onSubmit={submit}>
          ...
          <div className="field">
            ...
            <input id="u" autoComplete="username" value={username}
              onChange={e => setUser(e.target.value)} placeholder="asashiki" />
          </div>
          <div className="field">
