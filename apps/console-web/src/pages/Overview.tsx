                  ...
                  return (
                    <li key={t.skillId}>
                      ...
                      <span className="nm">
                        ...
                        <span className="id">{t.skillId}</span>
                      </span>
                      <span className="ct">
      ...
      <div className="card deco" style={{ marginTop: 16 }}>
        ...
        {!health.data ? (
          ...
          <div className="sys-grid">
            <HealthItem nm="mcp-gateway" status={health.data.gateway.ok ? "ok" : "err"} meta={`:4200 · ${health.data.gateway.uptime}`} />
            <HealthItem nm="core-api"    status={health.data.coreApi.ok ? "ok" : "err"} meta={`:4100${health.data.coreApi.note ? " · " + health.data.coreApi.note : ""}`} />
